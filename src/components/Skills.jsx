...
const SkillCard = forwardRef(function SkillCard({ skill, index }, ref) {
  ...
  return (
    ...
    >
      <div
        className={`glass-premium rounded-2xl p-6 text-center cursor-pointer transition-all duration-300 hover:bg-white/10 hover:border-accent-primary/40 relative overflow-hidden ${
          isHovered ? 'shadow-xl shadow-accent-primary/25' : ''
        }`}
      >
        <div className="flex justify-center mb-4">
          ...
          >
            {IconComponent && <IconComponent size={32} color={skill.color} />}
          </motion.div>
        </div>
