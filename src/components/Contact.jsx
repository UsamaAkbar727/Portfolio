...
import { FaGithub, FaLinkedin, FaEnvelope, FaMapMarkerAlt, FaCheck, FaPaperPlane, FaExclamationCircle } from 'react-icons/fa';
...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const serviceID = 'service_swbbqfd';
      const templateID = 'template_0ivsckn';
      const publicKey = 'OIMkSpaJgtN7NmWDy';
      ...
      if (error.status === 400) {
        ...
        console.log('🔍 400 Error - Check if Service ID and Template ID are correct');
            ...
            <motion.div variants={itemVariants} className="glass rounded-2xl p-8">
              ...
              {submitMessage && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -10 }}
                  className={`mb-6 p-4 rounded-xl flex items-center gap-3 ${submitMessage.includes('Failed')
                  ...
                  >
                    <div className="grid sm:grid-cols-2 gap-6">
                      ...
                      >
                        ...
                        <input
                          ...
                          className={`w-full px-4 py-3 bg-white/5 border rounded-xl text-white placeholder-text-secondary/50 focus:outline-none focus:ring-2 focus:ring-accent-primary/20 transition-all duration-300 ${errors.name
                      ...
                      >
                        ...
                        <input
                          ...
                          className={`w-full px-4 py-3 bg-white/5 border rounded-xl text-white placeholder-text-secondary/50 focus:outline-none focus:ring-2 focus:ring-accent-primary/20 transition-all duration-300 ${errors.email
                            ? 'border-red-500/50 focus:border-red-500'
                            : 'border-white/10 focus:border-accent-primary/50'
                            }`}
                    ...
                    >
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 bg-white/5 border rounded-xl text-white placeholder-text-secondary/50 focus:outline-none focus:ring-2 focus:ring-accent-primary/20 transition-all duration-300 ${errors.subject
                          ? 'border-red-500/50 focus:border-red-500'
                          : 'border-white/10 focus:border-accent-primary/50'
                          }`}
                    ...
                    >
                      ...
                      <textarea
                        ...
                        className={`w-full px-4 py-3 bg-white/5 border rounded-xl text-white placeholder-text-secondary/50 focus:outline-none focus:ring-2 focus:ring-accent-primary/20 transition-all duration-300 resize-none ${errors.message
                          ? 'border-red-500/50 focus:border-red-500'
                          : 'border-white/10 focus:border-accent-primary/50'
                          }`}
